...
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-2-1]{Continuous Delivery}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{cd-book-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Continuous Delivery};
\end{tikzpicture}
...
\begin{frame}[label=sec-2-2]{Pipeline}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-2-3]{Automation}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{cd-automation-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Automation};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-3-1]{Maven}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{maven-definition-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Maven};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-3-2]{Modularization}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{maven-graph-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Modularization};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-3-3]{Parent POM}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{maven-graph-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Parent POM};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-3-4]{Versioning}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{maven-versioning-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Versioning};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-1]{Jenkins}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{jenkins-definition-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Jenkins};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-2]{\textit{get-new-version}}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{jenkins-get-new-version-1-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {\textit{get-new-version}};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-3]{\textit{get-new-version}}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-4]{\textit{get-new-version}}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-5]{\textit{get-new-version} (3)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{jenkins-get-new-version-3-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {\textit{get-new-version} (3)};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-6]{\textit{get-new-version} (3)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-7]{\textit{get-new-version} (4)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{jenkins-get-new-version-4-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {\textit{get-new-version} (4)};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-8]{\textit{get-new-version} (4)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-9]{\textit{get-new-version} (4)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-4-10]{\textit{get-new-version}}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-5-1]{Docker}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{docker-definition-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Docker};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-5-2]{Docker}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-5-3]{Docker Concepts (1)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{docker-concepts-1-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Docker Concepts (1)};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-5-4]{Docker Concepts (2)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{docker-concepts-2-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Docker Concepts (2)};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-5-5]{phusion-baseimage}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{docker-phusion-baseimage-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {phusion-baseimage};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-5-6]{Dockerfile templates}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{docker-dockerfile-templates-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Dockerfile templates};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-1]{Shipyard}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{shipyard-definition-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Shipyard};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-2]{Citadel}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{shipyard-citadel-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Citadel};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-1]{Puppet}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{puppet-definition-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Puppet};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-2]{Puppet}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-3]{Puppet on guests}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{puppet-on-guests-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Puppet on guests};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-4]{Puppet on hosts}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{puppet-on-hosts-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Puppet on hosts};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-5]{Puppet to build data-container images}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{puppet-to-build-data-container-images-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Puppet to build data-container images};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-6]{Puppet to manage data-container images}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{puppet-to-manage-data-container-images-1-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Puppet to manage data-container images};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-7]{Puppet to manage data-container images}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-8-1]{MCollective}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-definition-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {MCollective};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-8-2]{ssh in a loop (1)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-ssh-in-a-loop-1-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {ssh in a loop (1)};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-8-3]{ssh in a loop (2)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-ssh-in-a-loop-2-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {ssh in a loop (2)};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-8-4]{MCollective}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-8-5]{Architecture}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-architecture-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Architecture};
\end{tikzpicture}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-8-6]{Middleware}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-middleware-bg.png}
};
\node[shift={(4.5cm, -0.9cm)}, right] at (current page.north west) {Middleware};
\end{tikzpicture}
\end{frame}
} % background
