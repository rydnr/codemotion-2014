...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-2]{Puppet}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-3]{Puppet on guests}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-4]{Puppet on hosts}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-5]{Puppet to build data-container images}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-6-7]{Puppet to manage data-container images}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
