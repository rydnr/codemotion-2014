% Created 2014-11-20 Thu 06:42
\documentclass[presentation,c]{beamer}
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-maven.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-jenkins.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-7]{Releasing the child module}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-7-10]{\textit{get-new-version} job fix}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-docker.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-shipyard.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{shipyard-dashboard.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{shipyard-containers.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-12-1]{}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-puppet.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-13-3]{Puppet on guests}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-13-5]{Puppet to manage data-container images}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-mcollective.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-in-a-loop-1-bg.png}
};
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-15-3]{ssh in a loop (2)}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{mcollective-in-a-loop-2-bg.png}
};
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-15-6]{Middleware}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-16-1]{}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{flow-complete.png}
};
\node[shift={(4.5cm, -0.44cm)}, right] at (current page.north west) {};
\end{tikzpicture}
\end{frame}
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-16-2]{Now what?}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
...
\item Take \url{http://github.com/rydnr/acmsl-jenkins-configs} as a template for \textbf{get-new-version} job.
...
{
\setbeamertemplate{navigation symbols}{}
\begin{frame}[label=sec-16-3]{And then?}
\begin{tikzpicture}[remember picture,overlay]
\node[at=(current page.center)] {
\includegraphics[width=\paperwidth]{now-what-bg.png}
};
